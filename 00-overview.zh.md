...
持有 30,000 ATOS 的用户,每 24 小时获得 220,000 gas 单位的免费交易额度,并持续回充。持有 1,000,000 ATOS 的用户还额外获得免费的合约部署额度。持仓更少、或想发送超过额度的用户,回退到标准 gas 计费的交易 —— 但门槛很低。
...
1. **能量优先。** 签名者账户持续累积 `TxEnergy`,上限为 `floor(余额 / 30,000 ATOS) × 220,000` 单位。每笔交易从这个池子里消耗。
